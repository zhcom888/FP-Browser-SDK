...
PermissionType102 = {
    ...
    PermissionType.IMAGES: 1,  # 1
    PermissionType.JAVASCRIPT: 2,  # 2
    ...
    PermissionType.POPUPS: 3,  # 3

    PermissionType.GEOLOCATION: 4,  # 4
    PermissionType.NOTIFICATIONS: 5,  # 5
    PermissionType.AUTO_SELECT_CERTIFICATE: 6,  # 6
    PermissionType.MIXEDSCRIPT: 7,  # 7
    PermissionType.MEDIASTREAM_MIC: 8,  # 8
    PermissionType.MEDIASTREAM_CAMERA: 9,  # 9
    PermissionType.PROTOCOL_HANDLERS: 10,  # 10
    PermissionType.PPAPI_BROKER: 11,  # 11
    PermissionType.AUTOMATIC_DOWNLOADS: 12,  # 12
    PermissionType.MIDI_SYSEX: 13,  # 13
    PermissionType.SSL_CERT_DECISIONS: 14,  # 14
    PermissionType.PROTECTED_MEDIA_IDENTIFIER: 15,  # 15
    PermissionType.APP_BANNER: 16,  # 16
    PermissionType.SITE_ENGAGEMENT: 17,  # 17
    PermissionType.DURABLE_STORAGE: 18,  # 18
    PermissionType.USB_CHOOSER_DATA: 19,  # 19
    PermissionType.BLUETOOTH_GUARD: 20,  # 20
    PermissionType.BACKGROUND_SYNC: 21,  # 21
    PermissionType.AUTOPLAY: 22,  # 22
    PermissionType.IMPORTANT_SITE_INFO: 23,  # 23
    PermissionType.PERMISSION_AUTOBLOCKER_DATA: 24,  # 24
    PermissionType.ADS: 25,  # 25

    # Website setting which stores metadata for the subresource filter to aid in
    # decisions for whether or not to show the UI.
    PermissionType.ADS_DATA: 26,  # 26

    # This is special-cased in the permissions layer to always allow, and as
    # such doesn't have associated prefs data.
    PermissionType.MIDI: 27,  # 27

    # This content setting type is for caching password protection service's
    # verdicts of each origin.
    PermissionType.PASSWORD_PROTECTION: 28,  # 28

    # Website setting which stores engagement data for media related to a
    # specific origin.
    PermissionType.MEDIA_ENGAGEMENT: 29,  # 29

    # Content setting which stores whether or not the site can play audible
    # sound. This will not block playback but instead the user will not hear it.
    PermissionType.SOUND: 30,  # 30
    ...
    # from that origin.
    PermissionType.CLIENT_HINTS: 31,  # 31
    ...
    PermissionType.INTENT_PICKER_DISPLAY: 37,  # 37

    # Used to store whether to allow a website to detect user active/idle state.
    PermissionType.IDLE_DETECTION: 38,  # 38

    # Setting for enabling auto-select of all screens for getDisplayMediaSet.
    PermissionType.GET_DISPLAY_MEDIA_SET_SELECT_ALL_SCREENS: 39,  # 39

    # Content settings for access to serial ports. The "guard" content setting
    # stores whether to allow sites to ask for permission to access a port. The
    # permissions granted to access particular ports are stored in the "chooser
    # data" website setting.
    PermissionType.SERIAL_GUARD: 40,  # 40
    PermissionType.SERIAL_CHOOSER_DATA: 41,  # 41
    ...
    PermissionType.PERIODIC_BACKGROUND_SYNC: 42,  # 42

    # Content setting which stores whether to allow sites to ask for permission
    # to do Bluetooth scanning.
    PermissionType.BLUETOOTH_SCANNING: 43,  # 43
    ...
    # data" website setting.
    PermissionType.HID_GUARD: 44,  # 44
    PermissionType.HID_CHOOSER_DATA: 45,  # 45
    ...
    PermissionType.WAKE_LOCK_SCREEN: 46,  # 46
    PermissionType.WAKE_LOCK_SYSTEM: 47,  # 47
    ...
    PermissionType.LEGACY_COOKIE_ACCESS: 48,  # 48
    ...
    PermissionType.FILE_SYSTEM_READ_GUARD: 58,  # 58
    ...
    PermissionType.DISPLAY_CAPTURE: 66,  # 66
    ...
    PermissionType.FILE_SYSTEM_ACCESS_CHOOSER_DATA: 67,  # 67
    ...
    PermissionType.FEDERATED_IDENTITY_SHARING: 68,  # 68
    ...
    PermissionType.FEDERATED_IDENTITY_REQUEST: 69,  # 69

    # Whether to use the v8 optimized JIT for running JavaScript on the page.
    PermissionType.JAVASCRIPT_JIT: 70,  # 70
